...
default_args = {
    ...
    "start_date":datetime(year=2019, month=9, day=15),
...
dag = DAG("Keywords_check_1", default_args=default_args, schedule_interval='10 10 * * *')
...
dag2 = DAG("Keywords_check_2", default_args=default_args, schedule_interval='12 10 * * *')
