...
#Function to use S3 hook to push files
...
#pushing master file to S3 in AWS
KW1_t4 = PythonOperator(task_id='upload_to_S3_1', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
...
KW2_t5 = PythonOperator(task_id='upload_to_S3_2', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw2/kw2.csv',
        'key': 'kw2.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW3_t5 = PythonOperator(task_id='upload_to_S3_3', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw3/kw3.csv',
        'key': 'kw3.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW4_t5 = PythonOperator(task_id='upload_to_S3_4', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw4/kw4.csv',
        'key': 'kw4.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW5_t5 = PythonOperator(task_id='upload_to_S3_5', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw5/kw5.csv',
        'key': 'kw5.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW6_t5 = PythonOperator(task_id='upload_to_S3_6', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw6/kw6.csv',
        'key': 'kw6.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW7_t5 = PythonOperator(task_id='upload_to_S3_7', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw7/kw7.csv',
        'key': 'kw7.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW8_t5 = PythonOperator(task_id='upload_to_S3_8', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw8/kw8.csv',
        'key': 'kw8.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW9_t5 = PythonOperator(task_id='upload_to_S3_9', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw9/kw9.csv',
        'key': 'kw9.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW10_t5 = PythonOperator(task_id='upload_to_S3_10', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw10/kw10.csv',
        'key': 'kw10.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW1_t1 >> KW1_t2 >> KW1_t3 >> KW1_t4 >> sub_dag

KW2_t1 >> KW2_t2 >> KW2_t3 >> KW2_t4 >> KW2_t5 >> sub_dag

KW3_t1 >> KW3_t2 >> KW3_t3 >> KW3_t4 >> KW3_t5 >> sub_dag

KW4_t1 >> KW4_t2 >> KW4_t3 >> KW4_t4 >> KW4_t5 >> sub_dag

KW5_t1 >> KW5_t2 >> KW5_t3 >> KW5_t4 >> KW5_t5 >> sub_dag

KW6_t1 >> KW6_t2 >> KW6_t3 >> KW6_t4 >> KW6_t5 >> sub_dag

KW7_t1 >> KW7_t2 >> KW7_t3 >> KW7_t4 >> KW7_t5 >> sub_dag

KW8_t1 >> KW8_t2 >> KW8_t3 >> KW8_t4 >> KW8_t5 >> sub_dag

KW9_t1 >> KW9_t2 >> KW9_t3 >> KW9_t4 >> KW9_t5 >> sub_dag

KW10_t1 >> KW10_t2 >> KW10_t3 >> KW10_t4 >> KW10_t5 >> sub_dag
...
KW11_t5 = PythonOperator(task_id='upload_to_S3_11', python_callable=upload_file_to_S3_with_hook, 
        op_kwargs={
        'filename': '/usr/local/airflow/dags/kw11/kw11.csv',
        'key': 'kw11.csv',
        'bucket_name': 'bucket-test85',
        'replace':'True'
        },
...
KW11_t1 >> KW11_t2 >> KW11_t3 >> KW11_t4 >> KW11_t5 
