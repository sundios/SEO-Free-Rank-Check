...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  9 22:11:03 2019
...
path = '/usr/local/airflow/dags/kw11/' ## airflow
#path = '/Users/konradburchardt/Desktop/docker-airflow/dags'  ##local
os.chdir(path)
files = sorted(glob.glob(os.path.join(path,'kw11.csv')))
...
path2 = '/usr/local/airflow/dags/kw11/rankings/' ## airflow
...
#exporting to CSV
export_csv = ranks.to_csv (r'/usr/local/airflow/dags/kw11/kw11.csv', index =True,index_label = 'id', header=True)
